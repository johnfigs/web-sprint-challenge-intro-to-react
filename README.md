...
-React JS is an open-source frontend javascript library. The problem it intends to solve is allows apps to be more performant in doing mass manipulations to the DOM as React only updates (repaints) the dom with the changes it finds between the DOM and virtual DOM. 

1. Describe component state.

-component state is a 'snapshot' of your data (variables, properties) at a given point in a component. 

1. Describe props.

-props is a helper object that is used share state between components. 

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

-A side effect is anything that affects something outside the function scope that being executed such as fetching data, logging, or manipulating the DOM. We can sync effects using UseEffect hook and pass along dependency array as the second argument in the effect hook. This will allow us to specify which state or props the effect should be synced with.
